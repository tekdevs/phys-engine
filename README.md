...
## **About**
Phys Engine is a 3D game engine & editor written completely in Python. The project utilises a variety libraries in order to create complex and optimised games intuitively. Phys Engine also includes a highly-developed editor in which presents numerous tools to help ease the development process.
...
<img width="1437" height="1032" alt="image" src="https://github.com/user-attachments/assets/061cc91f-e275-40fd-b213-48d7a9989295" />
